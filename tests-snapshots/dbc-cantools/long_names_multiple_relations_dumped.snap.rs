...
#[allow(dead_code)]
pub const DBC_FILE_NAME: &str = "long_names_multiple_relations_dumped";
...
impl Messages {
    ...
    pub fn from_can_message(id: Id, payload: &[u8]) -> Result<Self, CanError> {
        let res = match id {
            MsgLongName5678912345678912::MESSAGE_ID => {
                Messages::MsgLongName5678912345678912(
                    MsgLongName5678912345678912::try_from(payload)?,
                )
            }
            TxTwice::MESSAGE_ID => Messages::TxTwice(TxTwice::try_from(payload)?),
            RxTx1::MESSAGE_ID => Messages::RxTx1(RxTx1::try_from(payload)?),
            MsgCaseTest::MESSAGE_ID => {
                Messages::MsgCaseTest(MsgCaseTest::try_from(payload)?)
            }
            MsgCaseTest::MESSAGE_ID => {
                Messages::MsgCaseTest(MsgCaseTest::try_from(payload)?)
            }
            MsgWithValueTableSigs::MESSAGE_ID => {
                Messages::MsgWithValueTableSigs(
                    MsgWithValueTableSigs::try_from(payload)?,
                )
            }
            MsgLongName5678912345670000::MESSAGE_ID => {
                Messages::MsgLongName5678912345670000(
                    MsgLongName5678912345670000::try_from(payload)?,
                )
            }
            MsgLongName5678912345670001::MESSAGE_ID => {
                Messages::MsgLongName5678912345670001(
                    MsgLongName5678912345670001::try_from(payload)?,
                )
            }
...
impl MsgWithValueTableSigs {
    ...
    pub fn new(
        ...
        sig_with_long_val_table_1: MsgWithValueTableSigsSigWithLongValTable1,
    ) -> Result<Self, CanError> {
    ...
    pub fn sig_with_short_val_table(&self) -> MsgWithValueTableSigsSigWithShortValTable {
        ...
        match signal {
            1 => {
                MsgWithValueTableSigsSigWithShortValTable::VeryLongLongLongDescriptionForTheValue0x1
            }
            0 => {
                MsgWithValueTableSigsSigWithShortValTable::VeryLongLongLongDescriptionForTheValue0x0
            }
            _ => {
    ...
    pub fn sig_with_long_val_table_2(
        &self,
    ) -> MsgWithValueTableSigsSigWithLongValTable2 {
