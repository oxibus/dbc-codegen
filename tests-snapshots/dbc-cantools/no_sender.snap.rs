// Generated code!
//
// Message definitions from file `no_sender`
// Version: 
...
impl Foo {
    pub const MESSAGE_ID: embedded_can::Id = Id::Standard(unsafe { StandardId::new_unchecked(0x1d8)});
    ...
    /// - Value type: Signed
    #[inline(always)]
    pub fn signal_without_sender_raw(&self) -> i8 {
