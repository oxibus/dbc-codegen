...
#[allow(dead_code)]
pub const DBC_FILE_NAME: &str = "issue_184_extended_mux_cascaded_dumped";
    ...
    pub fn from_can_message(id: Id, payload: &[u8]) -> Result<Self, CanError> {
        let res = match id {
            ExtMuxCascaded::MESSAGE_ID => {
                Messages::ExtMuxCascaded(ExtMuxCascaded::try_from(payload)?)
            }
...
impl ExtMuxCascaded {
    ...
    /// Constructs a new `ext_MUX_cascaded` message from values.
    ...
    /// Returns the raw `ext_MUX_cascaded` message payload.
    pub fn raw(&self) -> &[u8; 8] {
        &self.raw
    }
    /// Returns the raw value of `muxed_A_2_MUX_B`.
    ///
    /// - Start bit: 8
    /// - Signal size: 8 bits
    ...
    /// Sets the raw value of `muxed_A_2_MUX_B`.
    #[allow(dead_code)]
    #[inline(always)]
    ...
    /// Selects the active multiplexed sub-message for `muxed_A_2_MUX_B`.
    pub fn muxed_a_2_mux_b_multiplexed(
        &mut self,
    ) -> Result<ExtMuxCascadedMuxedA2MuxBIndex, CanError> {
        match self.muxed_a_2_mux_b_raw_val() {
            0 => {
                Ok(
            ...
            1 => {
                Ok(
                    ExtMuxCascadedMuxedA2MuxBIndex::M1(ExtMuxCascadedMuxedA2MuxBM1 {
                        raw: self.raw,
                    }),
                )
            }
    ...
    /// Sets the value of `muxed_A_2_MUX_B`.
    #[inline(always)]
    ...
    pub fn set_m0(
        &mut self,
        value: ExtMuxCascadedMuxedA2MuxBM0,
    ) -> Result<(), CanError> {
    ...
    pub fn set_m1(
        &mut self,
        value: ExtMuxCascadedMuxedA2MuxBM1,
    ) -> Result<(), CanError> {
        let b0 = BitArray::<_, LocalBits>::new(self.raw);
        let b1 = BitArray::<_, LocalBits>::new(value.raw);
        self.raw = b0.bitor(b1).into_inner();
    ...
    pub fn mux_a_multiplexed(&mut self) -> Result<ExtMuxCascadedMuxAIndex, CanError> {
        match self.mux_a_raw_val() {
            ...
            1 => {
                Ok(
                    ExtMuxCascadedMuxAIndex::M1(ExtMuxCascadedMuxAM1 {
                        raw: self.raw,
                    }),
                )
            }
...
#[derive(Default)]
pub struct ExtMuxCascadedMuxedA2MuxBM0 {
    raw: [u8; 8],
}
#[allow(
    clippy::absurd_extreme_comparisons,
...
impl ExtMuxCascadedMuxedA2MuxBM0 {
    ...
    /// Returns the value of `muxed_B_0`.
    ///
    /// - Min: 0
    /// - Max: 0
    /// - Unit: Not specified
    ...
    /// Sets the raw value of `muxed_B_0`.
    #[inline(always)]
    pub fn set_muxed_b_0_raw_val(&mut self, value: i8) {
        let value = u8::from_ne_bytes(value.to_ne_bytes());
        self.raw.view_bits_mut::<Lsb0>()[16..24].store_le(value);
    }
    /// Sets the value of `muxed_B_0`.
    #[inline(always)]
...
#[derive(Default)]
pub struct ExtMuxCascadedMuxedA2MuxBM1 {
    raw: [u8; 8],
}
#[allow(
    clippy::absurd_extreme_comparisons,
