...
#[allow(dead_code)]
pub const DBC_FILE_NAME: &str = "val_table";
...
impl Message1 {
    ...
    pub fn new(signal1: Message1Signal1) -> Result<Self, CanError> {
...
impl From<Message1Signal1> for i8 {
    fn from(val: Message1Signal1) -> i8 {
        match val {
            Message1Signal1::One => 1,
            Message1Signal1::Zero => 0,
