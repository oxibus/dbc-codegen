...
#[allow(dead_code)]
pub const DBC_FILE_NAME: &str = "issue_184_extended_mux_multiple_values_dumped";
...
impl Messages {
    ...
    pub fn from_can_message(id: Id, payload: &[u8]) -> Result<Self, CanError> {
        let res = match id {
            ExtMuxMultipleValues::MESSAGE_ID => {
                Messages::ExtMuxMultipleValues(ExtMuxMultipleValues::try_from(payload)?)
            }
...
impl ExtMuxMultipleValues {
    ...
    pub fn mux(&mut self) -> Result<ExtMuxMultipleValuesMuxIndex, CanError> {
        match self.mux_raw() {
            ...
            1 => {
                Ok(
                    ExtMuxMultipleValuesMuxIndex::M1(ExtMuxMultipleValuesMuxM1 {
                        raw: self.raw,
                    }),
                )
            }
            2 => {
                Ok(
                    ExtMuxMultipleValuesMuxIndex::M2(ExtMuxMultipleValuesMuxM2 {
                        raw: self.raw,
                    }),
                )
            }
...
#[derive(Default)]
pub struct ExtMuxMultipleValuesMuxM0 {
    raw: [u8; 8],
}
#[allow(
    clippy::absurd_extreme_comparisons,
...
#[derive(Default)]
pub struct ExtMuxMultipleValuesMuxM1 {
    raw: [u8; 8],
}
#[allow(
    clippy::absurd_extreme_comparisons,
...
#[derive(Default)]
pub struct ExtMuxMultipleValuesMuxM2 {
    raw: [u8; 8],
}
#[allow(
    clippy::absurd_extreme_comparisons,
