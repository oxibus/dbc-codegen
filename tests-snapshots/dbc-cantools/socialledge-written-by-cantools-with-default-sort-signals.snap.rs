// Generated code!
//
// Message definitions from file `socialledge-written-by-cantools-with-default-sort-signals`
// Version: 
...
impl IoDebug {
    ...
    pub fn new(io_debug_test_float: f32, io_debug_test_signed: i8, io_debug_test_enum: u8, io_debug_test_unsigned: u8) -> Result<Self, CanError> {
