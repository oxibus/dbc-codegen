...
#[allow(dead_code)]
pub const DBC_FILE_NAME: &str = "issue_184_extended_mux_independent_multiplexors_dumped";
...
impl Messages {
    ...
    pub fn from_can_message(id: Id, payload: &[u8]) -> Result<Self, CanError> {
        let res = match id {
            ExtMuxIndepMultiplexors::MESSAGE_ID => {
                Messages::ExtMuxIndepMultiplexors(
                    ExtMuxIndepMultiplexors::try_from(payload)?,
                )
            }
...
impl ExtMuxIndepMultiplexors {
    ...
    /// Constructs a new `ext_MUX_indep_multiplexors` message from values.
    ...
    /// Returns the raw `ext_MUX_indep_multiplexors` message payload.
    ...
    /// - Value type: Signed
    #[inline(always)]
    pub fn mux_b_raw_val(&self) -> i8 {
        self.raw.view_bits::<Lsb0>()[16..24].load_le::<i8>()
    }
    /// Sets the raw value of `MUX_B`.
    #[allow(dead_code)]
    #[inline(always)]
    fn set_mux_b_raw_val(&mut self, value: i8) {
    ...
    pub fn mux_b_multiplexed(
        ...
        match self.mux_b_raw_val() {
            ...
            1 => {
                Ok(
                    ExtMuxIndepMultiplexorsMuxBIndex::M1(ExtMuxIndepMultiplexorsMuxBM1 {
                        raw: self.raw,
                    }),
                )
            }
            2 => {
                Ok(
                    ExtMuxIndepMultiplexorsMuxBIndex::M2(ExtMuxIndepMultiplexorsMuxBM2 {
                        raw: self.raw,
                    }),
                )
            }
    ...
    pub fn set_m0(
        &mut self,
        value: ExtMuxIndepMultiplexorsMuxBM0,
    ) -> Result<(), CanError> {
    ...
    pub fn set_m1(
        &mut self,
        value: ExtMuxIndepMultiplexorsMuxBM1,
    ) -> Result<(), CanError> {
        let b0 = BitArray::<_, LocalBits>::new(self.raw);
        let b1 = BitArray::<_, LocalBits>::new(value.raw);
        self.raw = b0.bitor(b1).into_inner();
    ...
    pub fn set_m2(
        &mut self,
        value: ExtMuxIndepMultiplexorsMuxBM2,
    ) -> Result<(), CanError> {
        let b0 = BitArray::<_, LocalBits>::new(self.raw);
        let b1 = BitArray::<_, LocalBits>::new(value.raw);
        self.raw = b0.bitor(b1).into_inner();
    ...
    pub fn mux_a_multiplexed(
        ...
        match self.mux_a_raw_val() {
            ...
            1 => {
                Ok(
                    ExtMuxIndepMultiplexorsMuxAIndex::M1(ExtMuxIndepMultiplexorsMuxAM1 {
                        raw: self.raw,
                    }),
                )
            }
            2 => {
                Ok(
                    ExtMuxIndepMultiplexorsMuxAIndex::M2(ExtMuxIndepMultiplexorsMuxAM2 {
                        raw: self.raw,
                    }),
                )
            }
    ...
    pub fn set_m0(
        &mut self,
        value: ExtMuxIndepMultiplexorsMuxAM0,
    ) -> Result<(), CanError> {
        let b0 = BitArray::<_, LocalBits>::new(self.raw);
        let b1 = BitArray::<_, LocalBits>::new(value.raw);
        self.raw = b0.bitor(b1).into_inner();
    ...
    pub fn set_m1(
        &mut self,
        value: ExtMuxIndepMultiplexorsMuxAM1,
    ) -> Result<(), CanError> {
        let b0 = BitArray::<_, LocalBits>::new(self.raw);
        let b1 = BitArray::<_, LocalBits>::new(value.raw);
        self.raw = b0.bitor(b1).into_inner();
    ...
    pub fn set_m2(
        &mut self,
        value: ExtMuxIndepMultiplexorsMuxAM2,
    ) -> Result<(), CanError> {
        let b0 = BitArray::<_, LocalBits>::new(self.raw);
        let b1 = BitArray::<_, LocalBits>::new(value.raw);
        self.raw = b0.bitor(b1).into_inner();
...
#[derive(Default)]
pub struct ExtMuxIndepMultiplexorsMuxBM0 {
    raw: [u8; 8],
}
#[allow(
    clippy::absurd_extreme_comparisons,
...
impl ExtMuxIndepMultiplexorsMuxBM0 {
    ...
    /// Returns the value of `muxed_A_0`.
    ///
    /// - Min: 0
    /// - Max: 0
    /// - Unit: Not specified
    ...
    /// - Value type: Signed
    #[inline(always)]
    pub fn muxed_a_0_raw_val(&self) -> i8 {
        self.raw.view_bits::<Lsb0>()[8..16].load_le::<i8>()
    }
    /// Sets the raw value of `muxed_A_0`.
    #[inline(always)]
    pub fn set_muxed_a_0_raw_val(&mut self, value: i8) {
        let value = u8::from_ne_bytes(value.to_ne_bytes());
        self.raw.view_bits_mut::<Lsb0>()[8..16].store_le(value);
    }
    /// Sets the value of `muxed_A_0`.
    #[inline(always)]
...
#[derive(Default)]
pub struct ExtMuxIndepMultiplexorsMuxBM1 {
    raw: [u8; 8],
}
#[allow(
    clippy::absurd_extreme_comparisons,
...
impl ExtMuxIndepMultiplexorsMuxBM1 {
    ...
    /// Returns the value of `muxed_B_1`.
    ///
    /// - Min: 0
    /// - Max: 0
    /// - Unit: Not specified
    ...
    /// Returns the value of `muxed_A_1`.
    ///
    /// - Min: 0
    /// - Max: 0
    /// - Unit: Not specified
    ...
    /// Sets the raw value of `muxed_A_1`.
    #[inline(always)]
    pub fn set_muxed_a_1_raw_val(&mut self, value: i8) {
        let value = u8::from_ne_bytes(value.to_ne_bytes());
        self.raw.view_bits_mut::<Lsb0>()[8..16].store_le(value);
    }
    /// Sets the value of `muxed_A_1`.
    #[inline(always)]
...
#[derive(Default)]
pub struct ExtMuxIndepMultiplexorsMuxBM2 {
    raw: [u8; 8],
}
#[allow(
    clippy::absurd_extreme_comparisons,
...
impl ExtMuxIndepMultiplexorsMuxBM2 {
    ...
    /// Returns the value of `muxed_B_2`.
    ///
    /// - Min: 0
    /// - Max: 0
    /// - Unit: Not specified
    ...
    /// - Value type: Signed
    #[inline(always)]
    pub fn muxed_b_2_raw_val(&self) -> i8 {
        self.raw.view_bits::<Lsb0>()[24..32].load_le::<i8>()
    }
    /// Sets the raw value of `muxed_B_2`.
    #[inline(always)]
    pub fn set_muxed_b_2_raw_val(&mut self, value: i8) {
        let value = u8::from_ne_bytes(value.to_ne_bytes());
        self.raw.view_bits_mut::<Lsb0>()[24..32].store_le(value);
    }
    /// Sets the value of `muxed_B_2`.
    #[inline(always)]
