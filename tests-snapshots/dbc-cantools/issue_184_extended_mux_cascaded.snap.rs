...
#[allow(dead_code)]
pub const DBC_FILE_NAME: &str = "issue_184_extended_mux_cascaded";
...
pub enum ExtMuxCascadedMuxAIndex {
    M0(ExtMuxCascadedMuxAM0),
    M1(ExtMuxCascadedMuxAM1),
}
#[allow(
    clippy::absurd_extreme_comparisons,
    clippy::excessive_precision,
...
#[derive(Default)]
pub struct ExtMuxCascadedMuxAM0 {
    raw: [u8; 8],
}
#[allow(
    clippy::absurd_extreme_comparisons,
...
#[derive(Default)]
pub struct ExtMuxCascadedMuxAM1 {
    raw: [u8; 8],
}
#[allow(
    clippy::absurd_extreme_comparisons,
