...
#[allow(dead_code)]
pub const DBC_FILE_NAME: &str = "attribute_Event";
#[allow(dead_code)]
...
impl Messages {
    ...
    pub fn from_can_message(id: Id, payload: &[u8]) -> Result<Self, CanError> {
        let res = match id {
            Inv2EventMsg1::MESSAGE_ID => {
                Messages::Inv2EventMsg1(Inv2EventMsg1::try_from(payload)?)
            }
    ...
    pub fn set_the_signal(&mut self, value: i8) -> Result<(), CanError> {
        if value < 0_i8 || 0_i8 < value {
            return Err(CanError::ParameterOutOfRange {
                message_id: Inv2EventMsg1::MESSAGE_ID,
            });
        }
        let factor = 1;
        let value = value
