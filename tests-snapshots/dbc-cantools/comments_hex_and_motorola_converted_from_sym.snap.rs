...
#[allow(dead_code)]
pub const DBC_FILE_NAME: &str = "comments_hex_and_motorola_converted_from_sym";
/// The version of the DBC file this code was generated from
#[allow(dead_code)]
pub const DBC_FILE_VERSION: &str = "6.0";
...
impl Msg1 {
    ...
    /// Selects the active multiplexed sub-message for `sig1`.
    pub fn sig1_multiplexed(&mut self) -> Result<Msg1Sig1Index, CanError> {
        match self.sig1_raw_val() {
