...
#[allow(dead_code)]
pub const DBC_FILE_NAME: &str = "fd_test";
#[allow(dead_code)]
...
impl Messages {
    ...
    pub fn from_can_message(id: Id, payload: &[u8]) -> Result<Self, CanError> {
        let res = match id {
            ...
            TestMsgStd::MESSAGE_ID => {
                Messages::TestMsgStd(TestMsgStd::try_from(payload)?)
            }
            TestMsgFdStd::MESSAGE_ID => {
                Messages::TestMsgFdStd(TestMsgFdStd::try_from(payload)?)
            }
            TestMsgFdEx::MESSAGE_ID => {
                Messages::TestMsgFdEx(TestMsgFdEx::try_from(payload)?)
            }
