...
impl TestInput {
    ...
    pub const VAR1_MAX: u16 = 65535_u16;
    pub const VAR2_MIN: u16 = 0_u16;
    pub const VAR2_MAX: u16 = 65535_u16;
    pub const VAR3_MIN: u16 = 0_u16;
...
/// Defined values for Test_input_Mux
#[allow(
    clippy::absurd_extreme_comparisons,
    clippy::excessive_precision,
    clippy::manual_range_contains,
...
pub enum TestInputTestInputMux {
    Multiplexer1,
    Multiplexer2,
    Multiplexer3,
    Multiplexer4,
...
impl From<TestInputTestInputMux> for u8 {
    fn from(val: TestInputTestInputMux) -> u8 {
        match val {
            TestInputTestInputMux::Multiplexer1 => 0,
            TestInputTestInputMux::Multiplexer2 => 1,
            TestInputTestInputMux::Multiplexer3 => 2,
            TestInputTestInputMux::Multiplexer4 => 3,
            TestInputTestInputMux::_Other(x) => x,
        }
    }
}
...
pub enum TestInputTestInputMuxIndex {
    M0(TestInputTestInputMuxM0),
    M1(TestInputTestInputMuxM1),
...
impl TestOutput {
    ...
    pub const VAR5_MAX: u16 = 65535_u16;
    pub const VAR6_MIN: u16 = 0_u16;
    pub const VAR6_MAX: u16 = 65535_u16;
    pub const VAR7_MIN: u16 = 0_u16;
...
/// Defined values for Test_output_Mux
#[allow(
    clippy::absurd_extreme_comparisons,
    clippy::excessive_precision,
    clippy::manual_range_contains,
...
#[derive(Clone, Copy, PartialEq)]
pub enum TestOutputTestOutputMux {
    Multiplexer1Out,
    Multiplexer2Out,
    Multiplexer3Out,
    Multiplexer4Out,
...
impl From<TestOutputTestOutputMux> for u8 {
    fn from(val: TestOutputTestOutputMux) -> u8 {
        match val {
            TestOutputTestOutputMux::Multiplexer1Out => 0,
            TestOutputTestOutputMux::Multiplexer2Out => 1,
            TestOutputTestOutputMux::Multiplexer3Out => 2,
            TestOutputTestOutputMux::Multiplexer4Out => 3,
            TestOutputTestOutputMux::_Other(x) => x,
        }
    }
}
...
pub enum TestOutputTestOutputMuxIndex {
    M0(TestOutputTestOutputMuxM0),
    M1(TestOutputTestOutputMuxM1),
