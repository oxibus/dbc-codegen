...
#[allow(dead_code)]
pub const DBC_FILE_NAME: &str = "DBC_template";
#[allow(dead_code)]
...
impl Messages {
    ...
    pub fn from_can_message(id: Id, payload: &[u8]) -> Result<Self, CanError> {
        let res = match id {
            CanMultiplexed::MESSAGE_ID => {
                Messages::CanMultiplexed(CanMultiplexed::try_from(payload)?)
            }
            CanMessage::MESSAGE_ID => {
                Messages::CanMessage(CanMessage::try_from(payload)?)
            }
...
impl CanMultiplexed {
    ...
    pub fn multiplexer(&mut self) -> Result<CanMultiplexedMultiplexerIndex, CanError> {
        match self.multiplexer_raw() {
            ...
            1 => {
                Ok(
                    CanMultiplexedMultiplexerIndex::M1(CanMultiplexedMultiplexerM1 {
                        raw: self.raw,
                    }),
                )
            }
    ...
    pub fn set_m0(
        &mut self,
        value: CanMultiplexedMultiplexerM0,
    ) -> Result<(), CanError> {
    ...
    pub fn set_m1(
        &mut self,
        value: CanMultiplexedMultiplexerM1,
    ) -> Result<(), CanError> {
        let b0 = BitArray::<_, LocalBits>::new(self.raw);
        let b1 = BitArray::<_, LocalBits>::new(value.raw);
        self.raw = b0.bitor(b1).into_inner();
...
#[derive(Default)]
pub struct CanMultiplexedMultiplexerM0 {
    raw: [u8; 2],
}
#[allow(
    clippy::absurd_extreme_comparisons,
...
#[derive(Default)]
pub struct CanMultiplexedMultiplexerM1 {
    raw: [u8; 2],
}
#[allow(
    clippy::absurd_extreme_comparisons,
