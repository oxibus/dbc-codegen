...
pub enum Messages {
    ...
    TestMsgEx(TestMsgEx),
    /// TestMsg_Std
    TestMsgStd(TestMsgStd),
    /// TestMsg_FDStd
    TestMsgFdStd(TestMsgFdStd),
    /// TestMsg_FDEx
    TestMsgFdEx(TestMsgFdEx),
}
...
impl Messages {
    ...
    pub fn from_can_message(id: Id, payload: &[u8]) -> Result<Self, CanError> {
        ...
        let res = match id {
            ...
            TestMsgFdStd::MESSAGE_ID => Messages::TestMsgFdStd(TestMsgFdStd::try_from(payload)?),
            TestMsgFdEx::MESSAGE_ID => Messages::TestMsgFdEx(TestMsgFdEx::try_from(payload)?),
...
impl TestMsgEx {
    ...
    pub fn set_test_sig_copy_1(&mut self, value: i8) -> Result<(), CanError> {
        if value < 0_i8 || 0_i8 < value {
            return Err(CanError::ParameterOutOfRange { message_id: TestMsgEx::MESSAGE_ID });
        }
        let factor = 1;
...
impl embedded_can::Frame for TestMsgEx {
...
impl TestMsgStd {
    ...
    pub fn set_test_sig_copy_3(&mut self, value: i8) -> Result<(), CanError> {
        if value < 0_i8 || 0_i8 < value {
            return Err(CanError::ParameterOutOfRange { message_id: TestMsgStd::MESSAGE_ID });
        }
        let factor = 1;
        let value = value.checked_sub(0)
...
impl embedded_can::Frame for TestMsgStd {
    fn new(id: impl Into<Id>, data: &[u8]) -> Option<Self> {
        if id.into() != Self::MESSAGE_ID {
            None
        } else {
...
impl TestMsgFdStd {
    ...
    pub fn set_test_sig_copy_2(&mut self, value: i8) -> Result<(), CanError> {
        if value < 0_i8 || 0_i8 < value {
            return Err(CanError::ParameterOutOfRange { message_id: TestMsgFdStd::MESSAGE_ID });
        }
        let factor = 1;
        let value = value.checked_sub(0)
...
impl embedded_can::Frame for TestMsgFdStd {
    fn new(id: impl Into<Id>, data: &[u8]) -> Option<Self> {
        if id.into() != Self::MESSAGE_ID {
            None
        } else {
...
impl TestMsgFdEx {
    ...
    pub fn set_test_sig(&mut self, value: i8) -> Result<(), CanError> {
        if value < 0_i8 || 0_i8 < value {
            return Err(CanError::ParameterOutOfRange { message_id: TestMsgFdEx::MESSAGE_ID });
        }
        let factor = 1;
        let value = value.checked_sub(0)
...
impl embedded_can::Frame for TestMsgFdEx {
    fn new(id: impl Into<Id>, data: &[u8]) -> Option<Self> {
        if id.into() != Self::MESSAGE_ID {
            None
        } else {
