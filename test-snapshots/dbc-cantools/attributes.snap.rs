// Generated code!
//
// Message definitions from file `attributes`
// Version: 
...
impl TheMessage {
    ...
    pub fn set_the_signal(&mut self, value: i8) -> Result<(), CanError> {
        if value < 0_i8 || 0_i8 < value {
            return Err(CanError::ParameterOutOfRange { message_id: TheMessage::MESSAGE_ID });
        }
        let factor = 1;
...
impl TheOtherMessage {
    ...
    pub fn set_the_signal(&mut self, value: i8) -> Result<(), CanError> {
        if value < 0_i8 || 0_i8 < value {
            return Err(CanError::ParameterOutOfRange { message_id: TheOtherMessage::MESSAGE_ID });
        }
        let factor = 1;
        let value = value.checked_sub(0)
