...
- *(fuzz)* make fuzz compile/run ([#140](https://github.com/oxibus/dbc-codegen/pull/140))
- optional padding bit value ([#184](https://github.com/oxibus/dbc-codegen/pull/184))
...
- 2024 edition, bump deps, minor fixes ([#196](https://github.com/oxibus/dbc-codegen/pull/196))
- [pre-commit.ci] pre-commit autoupdate ([#189](https://github.com/oxibus/dbc-codegen/pull/189))
- *(deps)* bump actions/checkout from 6 to 7 in the all-actions-version-updates group across 1 directory ([#191](https://github.com/oxibus/dbc-codegen/pull/191))
- Remove unsafe from generated MESSAGE_ID constants ([#194](https://github.com/oxibus/dbc-codegen/pull/194))
- Generate raw signal getters and setters ([#193](https://github.com/oxibus/dbc-codegen/pull/193))
- Support relation attributes in attribute_structs ([#192](https://github.com/oxibus/dbc-codegen/pull/192))
...
- Emit MESSAGE_CYCLE_TIME as integer ([#186](https://github.com/oxibus/dbc-codegen/pull/186))
